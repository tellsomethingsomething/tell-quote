        ...
        <div className="w-full bg-marketing-surface border border-marketing-border rounded-xl overflow-hidden shadow-2xl flex flex-col aspect-[16/10] text-left font-sans select-none">
            ...
            <div className="flex-1 bg-marketing-background p-6 overflow-hidden flex flex-col gap-4">
                ...
                <div className="grid grid-cols-4 gap-4">
                    {[
                        { label: 'Revenue', value: '$148,500', change: '+18%', up: true, icon: DollarSign },
                        { label: 'Expenses', value: '$62,300', change: '+5%', up: false, icon: Receipt },
                        { label: 'Net Profit', value: '$86,200', change: '+24%', up: true, icon: TrendingUp },
                        { label: 'Outstanding', value: '$23,400', change: '4 invoices', up: null, icon: FileText },
                    ].map((stat, i) => (
                        <div key={i} className="bg-marketing-surface border border-marketing-border p-4 rounded-lg">
                            ...
                            <div className="text-xl font-bold text-marketing-text-primary mb-1">{stat.value}</div>
                ...
                <div className="flex-1 bg-marketing-surface border border-marketing-border rounded-lg overflow-hidden">
                    ...
                    {[
                        ...
                        <div key={i} className="grid grid-cols-12 gap-4 p-3 border-b border-marketing-border/50 hover:bg-marketing-background/50 items-center text-sm">
                            ...
                            <div className="col-span-2 text-right text-marketing-text-secondary">${project.revenue.toLocaleString()}</div>
                            <div className="col-span-2 text-right text-red-400">${project.costs.toLocaleString()}</div>
                            <div className="col-span-2 text-right text-green-400 font-medium">${project.profit.toLocaleString()}</div>
