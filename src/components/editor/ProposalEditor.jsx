...
export default function ProposalEditor() {
    ...
    const canUseAI = hasAIFeatures && hasAnthropicKey;
    ...
    const handleGenerateProposal = async () => {
        ...
        try {
            ...
            if (canUseAI) {
                ...
                // Use template-based fallback for users without AI access
    ...
    return (
        <div className="card">
            ...
            <div className="space-y-5">
                ...
                {!hasAIFeatures && (
                    <div className="bg-gray-700/50 border border-gray-600 rounded-lg p-4 flex items-center gap-3">
                        ...
                        <div className="flex-1">
                            <span className="font-medium text-white text-sm">AI Proposals - Upgrade Required</span>
                            <p className="text-gray-400 text-xs mt-0.5">{aiUpgradeMessage || "Upgrade to Individual or Team plan for AI-generated proposals."}</p>
                        </div>
                ...
                {hasAIFeatures && !hasAnthropicKey && (
                    <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-3 text-xs text-amber-400">
                        <span className="font-medium">Anthropic API Key Required</span>
                        <p className="text-amber-400/70 mt-1">Add your API key in Settings → AI to enable AI-generated proposals.</p>
                    </div>
                )}
                    ...
                    >
                        {isGenerating ? (
                            ...
                            <>
                                ...
                                {proposal.proposalText ? 'Regenerate' : 'Generate'} {canUseAI ? 'with AI' : 'Template'}
                            </>
                        )}
                    </button>
