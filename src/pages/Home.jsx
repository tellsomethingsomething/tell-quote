...
export default function Home() {
    ...
    return (
        <Layout>
            <SEOHead
                title="ProductionOS - The Profit Platform for Production Companies"
                description="The first CRM built for production companies. Manage your company and see your profit on every job. Quotes, kit, crew, and finances in one platform for video and event production."
                path="/"
            />
                ...
                <section className="relative pt-32 pb-20 overflow-hidden text-center z-10 w-full">
                    <div className="container mx-auto px-6">
                        ...
                        >
                            ...
                            <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold tracking-tight mb-6 md:mb-8 leading-tight text-white">
                            ...
                            <p className="text-lg sm:text-xl md:text-2xl text-marketing-text-secondary max-w-3xl mx-auto mb-10 md:mb-12 leading-relaxed">
            ...
            <section className="pt-24 md:pt-48 pb-16 md:pb-24 bg-marketing-background">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-12 md:mb-20">
                        <h2 className="text-marketing-primary font-bold tracking-widest uppercase text-sm mb-3">WHY PRODUCTIONOS</h2>
                        <h3 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-4">Finally know if you're <br className="hidden sm:block" />making money.</h3>
            ...
            {/* --- PLATFORM FEATURES --- */}
            <section className="py-16 md:py-24 bg-marketing-surface border-y border-marketing-border overflow-hidden">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-8 md:mb-12">
                        <h2 className="text-marketing-primary font-bold tracking-widest uppercase text-sm mb-3">THE PLATFORM</h2>
                        <h3 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-4 md:mb-6">Everything in one place.</h3>
                        <p className="text-lg md:text-xl text-marketing-text-secondary max-w-2xl mx-auto">
            ...
            {/* --- SOCIAL PROOF --- */}
            <section className="py-16 md:py-24 border-b border-marketing-border bg-marketing-background overflow-hidden">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-10 md:mb-16">
                        <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-4 md:mb-6">Trusted by the industry's best.</h2>
                        <p className="text-lg md:text-xl text-marketing-text-secondary">Join over 200 production companies scaling with ProductionOS.</p>
                    </div>
                </div>
            ...
            <AuroraBackground showRadialGradient={false}>
                <section className="py-16 md:py-32 relative text-center w-full z-10">
                    <div className="container mx-auto px-6">
                        <h2 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-6 md:mb-8 text-white">Ready to know your margins?</h2>
                        <p className="text-lg md:text-xl text-marketing-text-secondary mb-8 md:mb-12 max-w-2xl mx-auto">
                            Stop guessing if jobs are profitable. Start your free trial and see your numbers clearly.
                        </p>
                        <div className="flex flex-col md:flex-row items-center justify-center gap-3 md:gap-4">
                            <Link to="/auth/signup" className="w-full sm:w-auto px-8 md:px-10 py-4 md:py-5 bg-marketing-primary text-white text-lg md:text-xl font-bold rounded-xl hover:bg-marketing-primary/90 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-marketing-primary focus:ring-offset-2 focus:ring-offset-marketing-background">
                                Start Free Trial
                            </Link>
                            <Link to="/pricing" className="w-full sm:w-auto px-8 md:px-10 py-4 md:py-5 bg-transparent border border-white/20 text-white text-lg md:text-xl font-bold rounded-xl hover:bg-white/10 transition-all focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-marketing-background">
                                View Pricing
                            </Link>
                        </div>
                        <p className="mt-6 md:mt-8 text-marketing-text-secondary text-sm opacity-70">
