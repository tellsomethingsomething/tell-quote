    ...
    return (
        <div className="flex flex-wrap gap-1.5 p-2 bg-dark-card border border-dark-border rounded-lg min-h-[44px]">
            {tags.map(tag => (
                <span
                    key={tag}
                    className="inline-flex items-center gap-1 px-2 py-0.5 bg-brand-primary/20 text-brand-primary text-xs rounded"
                >
                    {tag}
                    <button
    ...
    return (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div className="card text-center">
                <div className="text-2xl font-bold text-brand-primary">{stats.verifiedFragments}</div>
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 mb-6">
                <div className="card text-center">
                    <div className="text-2xl font-bold text-brand-primary">{upcomingEvents.length}</div>
                    ...
                    return (
                        <button
                            ...
                            className={`card text-center py-3 transition-all cursor-pointer ${
                                filterSport === sport ? 'ring-2 ring-brand-primary' : 'hover:border-gray-600'
                            }`}
                        >
